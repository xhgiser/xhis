        ...
        children: [
          {
            id: 211,
            label: '挡潮闸',
            layerName: 'xhis:water_sluice_tide',
            visible: false,
          },
          {
            id: 212,
            label: '分泄洪闸',
            layerName: 'xhis:water_sluice_flood_diversion',
            visible: false,
          },
          {
            id: 213,
            label: '节制闸',
            layerName: 'xhis:water_sluice_controlling',
            visible: false,
          },
          {
            id: 214,
            label: '排退水闸',
            layerName: 'xhis:water_sluice_outlet',
            visible: false,
          },
          {
            id: 215,
            label: '引进水闸',
            layerName: 'xhis:water_sluice_inlet',
            visible: false,
          },
        ],
      },
