    ...
    if (url) {
      fetch(url)
        ...
        .then((json) => {
          ...
          tableFeatureName.value = popupInfo.features[0].properties.地类名称
...
/* 地图图例 */
const MaplegendImage = require(`@/assets/images/MapLegend/plan-gtdc.png`)
