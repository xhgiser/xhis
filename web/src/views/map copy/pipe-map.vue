        ...
        children: [
          {
            id: 111,
            label: '原水管线',
            layerName: 'xhis:pipe_yjline',
            visible: false,
          },
          {
            id: 112,
            label: '原水管点',
            layerName: 'xhis:pipe_yjpoint',
            visible: false,
          },
        ],
      },
        ...
        children: [
          {
            id: 121,
            label: '自来水管线',
            layerName: 'xhis:pipe_jsline',
            visible: false,
          },
          {
            id: 122,
            label: '自来水管点',
            layerName: 'xhis:pipe_jspoint',
            visible: false,
          },
        ],
      },
        ...
        children: [
          {
            id: 131,
            label: '直饮水管线',
            layerName: 'xhis:pipe_zyline',
            visible: false,
          },
          {
            id: 132,
            label: '直饮水管点',
            layerName: 'xhis:pipe_zypoint',
            visible: false,
          },
        ],
      },
        ...
        children: [
          {
            id: 141,
            label: '绿化水管线',
            layerName: 'xhis:pipe_lhline',
            visible: false,
          },
          {
            id: 142,
            label: '绿化水管点',
            layerName: 'xhis:pipe_lhpoint',
            visible: false,
          },
        ],
      },
        ...
        children: [
          {
            id: 211,
            label: '雨水管线',
            layerName: 'xhis:pipe_ysline',
            visible: false,
          },
          {
            id: 212,
            label: '雨水井点',
            layerName: 'xhis:pipe_ysjpoint',
            visible: false,
          },
          {
            id: 213,
            label: '雨水篦点',
            layerName: 'xhis:pipe_ysbpoint',
            visible: false,
          },
        ],
      },
        ...
        children: [
          {
            id: 221,
            label: '污水管线',
            layerName: 'xhis:pipe_wsline',
            visible: false,
          },
          {
            id: 222,
            label: '污水管点',
            layerName: 'xhis:pipe_wspoint',
            visible: false,
          },
        ],
      },
        ...
        children: [
          {
            id: 231,
            label: '雨污合流管线',
            layerName: 'xhis:pipe_hsline',
            visible: false,
          },
          {
            id: 232,
            label: '雨污合流管点',
            layerName: 'xhis:pipe_hspoint',
            visible: false,
          },
        ],
      },
        ...
        children: [
          {
            id: 241,
            label: '排碱管线',
            layerName: 'xhis:pipe_pjline',
            visible: false,
          },
          {
            id: 242,
            label: '排碱管点',
            layerName: 'xhis:pipe_pjpoint',
            visible: false,
          },
        ],
      },
        ...
        children: [
          {
            id: 251,
            label: '中水管线',
            layerName: 'xhis:pipe_zsline',
            visible: false,
          },
          {
            id: 252,
            label: '中水管点',
            layerName: 'xhis:pipe_zspoint',
            visible: false,
          },
        ],
      },
...
//图层展开id
const defaultExpandedKeys = '1, 2, 3, 11, 12, 13, 14, 21, 22, 23 ,24 25'
//图层选择id
    ...
    if (url) {
      fetch(url)
        ...
        .then((json) => {
          ...
          tableFeatureName.value = popupInfo.features[0].properties.管线类型
